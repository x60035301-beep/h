...
const zhPages: Record<string, PageCopy> = {
  ...
  purchaseOrders: { title: "采购单管理", description: "创建、复制、查询并导出正式采购单。" },
...
const enPages: Record<string, PageCopy> = {
  ...
  purchaseOrders: { title: "Purchase Orders", description: "Create, copy, search, and export formal purchase orders." },
...
const idPages: Record<string, PageCopy> = {
  ...
  purchaseOrders: { title: "Pesanan Pembelian", description: "Buat, salin, cari, dan ekspor purchase order resmi." },
